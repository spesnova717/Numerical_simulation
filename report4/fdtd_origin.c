...
int main(){
    int i,j,k;
    double micro[NX+VALUE][NY+VALUE];
    double EZ[NX+VALUE][NY+VALUE];
    double HX[NX+VALUE][NY+VALUE];
    double HY[NX+VALUE][NY+VALUE];
    double CEZ[NX+VALUE][NY+VALUE];
    double CEZLX[NX+VALUE][NY+VALUE];
    double CEZLY[NX+VALUE][NY+VALUE];
    double CHXLY[NX+VALUE][NY+VALUE];
    double CHYLX[NX+VALUE][NY+VALUE];
